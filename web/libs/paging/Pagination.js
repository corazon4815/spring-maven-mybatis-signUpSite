$.fn.pageMe = function(opts){
    ...
    pager.find('.page_link:first').addClass('active_tbl');
    pager.find('.prev_link').hide();
    if (numPages<=1) {
        pager.find('.next_link').hide();
    }
  	pager.children().eq(1).addClass("active_tbl "+settings.activeColor);
    ...
    function goTo(page){
        ...
        pager.data("curr",page);
      	pager.children().removeClass("active_tbl "+settings.activeColor);
        pager.children().eq(page+1).addClass("active_tbl "+settings.activeColor);
